...
![Aba ML apos treino — metricas atualizadas (modelo: {model}, MAE: {mae})](../assets/evidencias/05_ml_depois.png)
*Aba ML apos treino — metricas atualizadas (modelo: {model}, MAE: {mae})*


![Dataset processado, predicoes e leaderboard de modelos ({rows} linhas)](../assets/evidencias/06_ml_dataset.png)
*Dataset processado, predicoes e leaderboard de modelos ({rows} linhas)*
...
![Historico temporal de analises ({vision_count} registros acumulados)](../assets/evidencias/09_vision_historico.png)
*Historico temporal de analises ({vision_count} registros acumulados)*
...
![Swagger UI com todos os endpoints disponiveis em http://127.0.0.1:8000/docs](../assets/evidencias/11_swagger.png)
*Swagger UI com todos os endpoints disponiveis em http://127.0.0.1:8000/docs*


### 3.7 Endpoint /report/summary — saida bruta

![Saida JSON de /report/summary consolidando pipeline e visao](../assets/evidencias/12_report_json.png)
*Saida JSON de /report/summary consolidando pipeline e visao*


### 3.8 Aba 05 · Relatorio consolidado

![Aba Relatorio com JSON renderizado e botao de download](../assets/evidencias/13_relatorio.png)
*Aba Relatorio com JSON renderizado e botao de download*


### 3.9 Aba 06 · PDF de Entrega

![Aba PDF com formulario preenchivel e gerador de PDF](../assets/evidencias/14_pdf_aba.png)
*Aba PDF com formulario preenchivel e gerador de PDF*
